...
export default function Testimonials () {
    ...
    <div className="flex justify-center py-5">
        <div className="bg-white w-[868px] h-[451px] rounded-lg shadow-lg p-6">
            <div className="flex justify-center">
                {/* Profile Image */}
                <img src="/images/test1.png" alt="Reviewer" className="w-24 h-24 rounded-full border-4 border-orange-500 mb-4" />
            </div>
