...
//         <img src="/images/choose1.png" alt="Food" className="w-[362px] h-[356px] object-cover rounded-lg mb-4"/>
//         <img src="/images/choose2.png" alt="Food" className="w-[281px] h-[231px] object-cover rounded-lg mb-4"/>
//       </div>
// <div className="ml-9 grid grid-cols-3 gap-3">
//   <img src="/images/choose3.png" alt="Food" className="w-[244px] h-[306px] object-cover rounded-lg"/>
//   <img src="/images/choose4.png" alt="Food" className="w-[221px] h-[226px] object-cover rounded-lg"/>
//   <img src="/images/choose5.png" alt="Food" className="w-[161px] h-[168px] object-cover rounded-lg mr-5"/>
// </div>

// <div className="grid grid-cols-3 gap-0 mt-0">
//   <img src="/images/choose6.png" alt="Food" className="w-[161px] h-[168px] object-cover rounded-lg ml-96"/>
// </div>
...
//         <img src="/images/choose0.png" alt="Fast Food" className="w-[102px] h-[100px] mb-2"/>
//         <p className="text-white">Fast Food</p>
//       </div>
//       <div className="flex flex-col items-center">
//         <img src="/images/choose0.png" alt="Lunch" className="w-[102px] h-[100px]  mb-2"/>
//         <p className="text-white">Lunch</p>
//       </div>
//       <div className="flex flex-col items-center">
//         <img src="/images/choose0.png" alt="Dinner" className="w-[102px] h-[100px] mb-2"/>
